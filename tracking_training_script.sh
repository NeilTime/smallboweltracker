...
#SBATCH --job-name=training_run             # Job name
...
#SBATCH --partition=luna-gpu-long           # Use long partition for actual training
#SBATCH --nodes=1                           # Number of nodes
#SBATCH --gres=gpu:1g.10gb:1                # Request GPU
#SBATCH --cpus-per-task=4                   # Number of CPU cores per task
#SBATCH --mem=32G                           # More memory for actual training
